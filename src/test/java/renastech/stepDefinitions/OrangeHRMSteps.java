...
public class OrangeHRMSteps {
    ...
    public void the_user_wants_to_add_an_employee_in_a_list_way(io.cucumber.datatable.DataTable dataTable) {


    }
    @Then("The user wants to add login details in a list way")
    public void the_user_wants_to_add_login_details_in_a_list_way(io.cucumber.datatable.DataTable dataTable) {
